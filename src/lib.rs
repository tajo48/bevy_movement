...
//!
//! This crate provides a flexible kinematic character controller system that supports:
//! - Basic directional movement and jumping
//! - Both keyboard and gamepad input
//! - Configurable maximum slope angle for climbing
//! - Manual collision detection and response
//! - Smooth movement with gravity simulation
//!
//! # Quick Start
//!
//! ```no_run
